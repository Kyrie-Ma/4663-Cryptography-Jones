import sys
"""
    This file implements a class that creates a Adfgx lookup table using a keyword to build a polybuis square of format: 
                      A D F G X 
                    A s u p e r 
                    D b a t z y 
                    F c d f g h 
...
class AdfgxLookup:
    ...
    def sanity_check(self):
        """ This method lets you look at an actual "matrix" that you      built using a keyword. 
            This is not what you would use to encrypt!! Its only a sanity check meaning that it visualizes the lookup table just to see proof it's correct.
        """
